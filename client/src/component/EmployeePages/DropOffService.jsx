...
export default function DropOffService() {
    return (
        <main className="flex flex-col gap-3 relative m-1 px-3 lg:pl-1 min-h-screen bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-sky-50 via-indigo-100 to-emerald-50 ">
            ...
            <div>
                <h1 className='sm:text-4xl lg:text-5xl px-2 font-semibold text-4xl text-center .text-gray-700 py-10'>DropOff <span className='font-extrabold'>Service</span></h1>
            </div>
