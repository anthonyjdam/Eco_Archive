    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-sky-50 via-indigo-100 to-emerald-50 ">
                ...
                {/* Sidebar */}
                <div className="flex-auto w-48 shadow-md">
                    <aside >
                        <AdminSidebar />
                    </aside>
                </div>
                ...
                {/* Top Bar */}
                <div className='flex-auto lg:pl-48'>
                ...
                {/* Iventory Summary */}
                <div className="flex-auto bottom-0 overflow-y-auto lg:pl-52 lg:pr-4 lg:pt-8 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-sky-50 via-indigo-100 to-emerald-50">
                    <div>
