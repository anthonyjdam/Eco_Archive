...
import AdminCustTable from './AdminCustTable'
import axios from 'axios';
// import AdminCustTableRow from './AdminTableRow';
...
function AdminEditCustomer() {
   ...
   * Customer SEARCH
   */
  async function handleCustSearch(e) {
    e.preventDefault();

    console.log("Search " + search);
    console.log("First name " + cusFName);
    ...
    const response = await axios.post("http://localhost:5000/api/selectCustWithName", searchObject);// returns an array of matching employee names
    console.log("Sandwich");
                      ...
                      <div className='flex flex-col items-start justify-start gap-5 pt-5'>
                        <div className='flex gap-4 items-center'>
                          ...
                          <input
                            ...
                            value={custUsername}
                            onChange={(e) => {
                              setCustUsername(e.target.value);
                            }}
                          ></input>
                        </div>
                        <div className='flex gap-4 items-center'>
