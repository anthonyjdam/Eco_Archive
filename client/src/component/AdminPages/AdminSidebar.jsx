        ...
        <div>
            <nav>
                <div className="fixed top-0 bottom-0 lg:left-0 p-0 w-48 flex-auto z-10 overflow-y-auto text-center bg-gray-900">
                    <div className="title flex items-center gap-3 flex-grow-0 mb-8 mt-5 ml-1">
                        <img src={logo} className="h-auto w-8" />
                        <h2 className="font-bold text-xl text-white">ECO ARCHIVE</h2>
                    </div>
                    <NavLink className="p-2.5 mt-3 w-full flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-400 text-white"
                        to="/admin"
                    >
                    ...
                    <NavLink className="p-2.5 mt-3 w-full flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-400 text-white"
                        to="/editemployee"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" className="w-6 h-6 mr-1">
                    ...
                    <NavLink className="p-2.5 mt-3 w-full flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-pink-300 text-white"
                        to="/editcharity"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" className="w-6 h-6 mr-1">
                ...
                <div className="fixed bottom-0 lg:left-0 p-0 w-48 overflow-y-auto flex-auto z-10 text-center bg-gray-900 shadow-sm">
